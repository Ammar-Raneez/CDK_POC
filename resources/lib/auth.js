...
exports.AuthService = exports.config = void 0;
...
aws_amplify_1["default"].configure({
    Auth: {
        ...
        userPoolId: exports.config.USER_POOL_ID,
        userPoolWebClientId: exports.config.APP_CLIENT_ID,
...
authService.login(exports.config.TEST_USERNAME, exports.config.TEST_PASSWORD);
